"""Tests for Immich Browser config flow."""
...
from custom_components.immich_browser.config_flow import CannotConnect
from custom_components.immich_browser.const import DOMAIN
...
async def test_form(hass: HomeAssistant, mock_setup_entry: AsyncMock) -> None:
    ...
    with patch(
        "custom_components.immich_browser.config_flow._async_validate_connection",
        return_value=None,
    ):
...
async def test_options_flow(hass: HomeAssistant) -> None:
    ...
    with (
        patch(
            "custom_components.immich_browser.async_setup_entry",
            return_value=True,
        ),
        patch(
            "custom_components.immich_browser.async_unload_entry",
            return_value=True,
        ),
        patch(
            "custom_components.immich_browser.config_flow._async_validate_connection",
